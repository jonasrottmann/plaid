...
public class HackerNewsStory extends Activity {
...
//        createDesignerNewsApi();
        ...
        if (story.descendants > 0) {
            ...
            List<Comment> flattened = new ArrayList<>(story.descendants);
//            unnestComments(story.comments, flattened);
    ...
    public static CustomTabsIntent.Builder getCustomTabIntent(@NonNull Context context,
        ...
        return new CustomTabsIntent.Builder(session)
                .setToolbarColor(ContextCompat.getColor(context, R.color.hacker_news))
    ...
    private View.OnClickListener fabClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            CustomTabActivityHelper.openCustomTab(
                    HackerNewsStory.this,
                    getCustomTabIntent(HackerNewsStory.this, story,
    ...
    private void doFabExpand() {
        ...
        Animator background = ObjectAnimator.ofArgb(fabExpand,
                ...
                ContextCompat.getColor(this, R.color.hacker_news),
        ...
        show.setInterpolator(getFastOutSlowInInterpolator(HackerNewsStory.this));
...
//                    Glide.with(HackerNewsStory.this)
//                            .load(src)
//                            .asBitmap()
...
//        }
        ...
        upvoteStory.setText(getResources().getQuantityString(R.plurals.upvotes, story.score, NumberFormat.getInstance().format(story.score)));
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(ShareCompat.IntentBuilder.from(HackerNewsStory.this)
                        .setText(story.url)
                        .setType("text/plain")
        ...
        SpannableString poster = new SpannableString("–" + story.by);
...
//        CharSequence job = !TextUtils.isEmpty(story.user_job) ? "\n" + story.user_job : "";
        CharSequence timeAgo = DateUtils.getRelativeTimeSpanString(story.time,
                System.currentTimeMillis(),
                DateUtils.SECOND_IN_MILLIS);
//        storyPosterTime.setText(TextUtils.concat(poster, job, "\n", timeAgo));
        storyPosterTime.setText(TextUtils.concat(poster, "", "\n", timeAgo));
...
//        Intent login = new Intent(HackerNewsStory.this,
//                DesignerNewsLogin.class);
//        login.putExtra(FabDialogMorphSetup.EXTRA_SHARED_ELEMENT_START_COLOR,
//                ContextCompat.getColor(HackerNewsStory.this, R.color.background_light));
...
//    }
    ...
    private boolean isOP(String userName) {
        return userName.equals(story.by);
    }
...
//                holder.author.setOriginalPoster(isOP(comment.by));
